...
public class RectangleScatterSeeder extends AbstractSeeder {

    public RectangleScatterSeeder(ControlSiteFinder csf) {
        super(csf);
    }
    ...
    public List<ControlSite> seed(List<ControlSite> initialPoints, int requestedNumControls, double requestedCourseLength) {
        ...
        var merged = merge(initialPoints, List.of(second, third, fourth), requestedNumControls);
