...
public class UPSCoordConverter {
    ...
    private String Hemisphere = gov.nasa.worldwind.geom.Hemisphere.NORTH;
    ...
    public long convertGeodeticToUPS(double latitude, double longitude) {
        ...
        if (latitude < 0) {
            ...
            Hemisphere = gov.nasa.worldwind.geom.Hemisphere.SOUTH;
        } else {
            UPS_Origin_Latitude = MAX_ORIGIN_LAT;
            Hemisphere = gov.nasa.worldwind.geom.Hemisphere.NORTH;
        }
        ...
        if (gov.nasa.worldwind.geom.Hemisphere.SOUTH.equals(Hemisphere))
            UPS_Northing = UPS_False_Northing - polarConverter.getNorthing();
    ...
    /**
     * @return Hemisphere, either {@link gov.nasa.worldwind.geom.Hemisphere#NORTH} or {@link
     * gov.nasa.worldwind.geom.Hemisphere#SOUTH}.
     */
     ...
     *
     * @param Hemisphere Hemisphere, either {@link gov.nasa.worldwind.geom.Hemisphere#NORTH} or {@link
     *                   gov.nasa.worldwind.geom.Hemisphere#SOUTH}.
    ...
    public long convertUPSToGeodetic(String Hemisphere, double Easting, double Northing) {
        ...
        if (!gov.nasa.worldwind.geom.Hemisphere.NORTH.equals(Hemisphere) && !gov.nasa.worldwind.geom.Hemisphere.SOUTH.equals(Hemisphere))
        ...
        if (gov.nasa.worldwind.geom.Hemisphere.NORTH.equals(Hemisphere))
            UPS_Origin_Latitude = MAX_ORIGIN_LAT;
        if (gov.nasa.worldwind.geom.Hemisphere.SOUTH.equals(Hemisphere))
            UPS_Origin_Latitude = -MAX_ORIGIN_LAT;
