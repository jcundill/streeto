...
class UTMCoordConverter {
    ...
    /**
     * @return The coordinate hemisphere, either {@link gov.nasa.worldwind.geom.Hemisphere#NORTH} or {@link
     ...
     *
     * @param Zone       UTM zone.
     * @param Hemisphere The coordinate hemisphere, either {@link gov.nasa.worldwind.geom.Hemisphere#NORTH} or {@link
     *                   gov.nasa.worldwind.geom.Hemisphere#SOUTH}.
    ...
    public long convertUTMToGeodetic(long Zone, String Hemisphere, double Easting, double Northing) {
        ...
        if (!Hemisphere.equals(gov.nasa.worldwind.geom.Hemisphere.SOUTH) && !Hemisphere.equals(gov.nasa.worldwind.geom.Hemisphere.NORTH))
...
//            Error_Code |= UTM_EASTING_ERROR;                       //that extend into another zone
        ...
        if (Error_Code == UTM_NO_ERROR) { /* no errors */
            ...
            if (Hemisphere.equals(gov.nasa.worldwind.geom.Hemisphere.SOUTH))
                False_Northing = 10000000;
            try {
